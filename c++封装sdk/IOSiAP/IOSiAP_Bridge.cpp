...
IOSiAP_Bridge::IOSiAP_Bridge(std::string ext)
{
    _quantity = 0;
    _identifier = "";
    _product = nullptr;
...
// 付款请求
void IOSiAP_Bridge::requestPayment(std::string ext, int quantity, iapPaymentCallback callback)
{
    _quantity = quantity;
    ...
    {
        // 支付请求
        iap->paymentWithProduct(_product, ext, _quantity);
    }
}
